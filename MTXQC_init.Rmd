...
### First steps:
    ...
    3. Open here a new Rproject
    4. Copy all files extracted from the zip-archive downloaded from github.
    5. Open MTXQC_init.Rmd (you are reading the knitted version)
    6. Click the small triangle next to the Knit button and select: Knit with parameter
    7. Define a project folder name
    8. Copy your Maui- or Metmax-derived input files
