...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={Sabrina Geisenberger (Mueller lab, MDC Berlin) and Christin Zasada (Kempa Lab, MDC)},
             pdfkeywords = {MTXQCvX, GC-MS, metabolomics, data analysis and processing},  
            pdftitle={MTXQCvX - Experimental Setup - Macrophage differentiation - Glc labeling},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
            linkcolor=magenta,
